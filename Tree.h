...
private:
	...
	bool insert_helper(const Tree& node, bool helper);
...
public:
	...
	bool insert(const Tree& node);
	bool remove(const int value);
    bool remove(const Tree& node);
	void print() const;
};
...
bool Tree::insert_helper(const Tree& node, bool helper)
{
...
bool Tree::insert(const int value)
{
...
bool Tree::insert(const Tree& node)
{
...
bool Tree::remove(const Tree& node)
{
